...
export class AddTrackingRecipientUnit1789434000000 implements MigrationInterface {
    name = 'AddTrackingRecipientUnit1789434000000';
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(
            this.read('1789434000000-add_tracking_recipient_unit.sql'),
        );
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        // Restores the function's pre-migration definition exactly (recipient
        // object without 'unit'), rather than dropping it -- other code depends
